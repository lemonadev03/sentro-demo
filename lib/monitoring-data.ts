...
export const sensors: Sensor[] = [
  {
    ...
    affectedBarangays: ["san-roque", "riverside", "malanday"],
  },
  {
    id: "RS-002",
    name: "Brgy. Riverside",
    ...
    affectedBarangays: ["riverside", "malanday"],
  },
  {
    id: "RS-003",
    name: "Brgy. Malanday",
  ...
  {
    id: "RS-004",
    name: "Brgy. Centro (Bridge)",
    normalLevel: 1.3,
    alertLevel: 1.3,
    status: "normal",
    rateOfChange: "+0.03m/hr",
    affectedBarangays: ["centro", "san-jose"],
  },
  {
    id: "RS-005",
    name: "Brgy. San Jose (Downstream)",
    normalLevel: 0.9,
    alertLevel: 0.9,
    status: "normal",
...
export const barangays: Barangay[] = [
  ...
  },
  {
    ...
    residents: 1820,
    riskLevel: "normal",
    evacuationCenter: "Riverside Covered Court",
  },
  {
    id: "malanday",
    name: "Malanday",
  ...
  },
  {
    ...
    residents: 4200,
    riskLevel: "normal",
    evacuationCenter: "Centro Sports Complex",
  },
  {
    id: "san-jose",
    name: "San Jose",
    residents: 2800,
    riskLevel: "normal",
    evacuationCenter: "San Jose Chapel Grounds",
  },
];
